...
import {
  ...
  preComponentLoader,
  tableComponentLoader, audioComponentLoader, videoComponentLoader,
...
import { ImageAndVideoDragResizePlugin, TableEditEnhancePlugin } from './plugins/_api'
...
export const defaultOptions: EditorOptions = {
  ...
  plugins: [
    ...
    new ImageAndVideoDragResizePlugin(),
    new TableEditEnhancePlugin()
  ]
}
